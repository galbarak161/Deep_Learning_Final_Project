...
---
Our main goal was to compare different classifying networks on the same input 
in order to find the network that provides the best results by taking into account the net's complexity (number of parameters) and training time.
